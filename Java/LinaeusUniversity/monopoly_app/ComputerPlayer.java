...
public class ComputerPlayer implements Player{
   ...
   */
  public ComputerPlayer(Tile currentTile, ConsoleUi ui) {
    this.ui = ui;
  ...
  public boolean yourTurn(Dice d1, Dice d2) {
    ConsoleUi.Action r = ConsoleUi.Action.ROLL;
    ConsoleUi.Action b = ConsoleUi.Action.BUY;
    ConsoleUi.Action n = ConsoleUi.Action.None;
    ConsoleUi.Action[] actions = {r, b, n};
    ConsoleUi.Action a = actions[new Random().nextInt(actions.length)];
    switch (a) {
      case ROLL:
        d1.roll();
        d2.roll();
